...
/***/ function(module, exports, __webpack_require__) {
	...
	var Combobox = __webpack_require__(2);
	...
	var App = React.createClass({displayName: 'App',
	  ...
	  render: function() {
	    var menuContent = this.state.states.length ?
	      ...
	      React.DOM.div( {style:{padding: '8px'}, 'aria-live':"polite"}, "No matches");
	    return (
	      React.DOM.div(null, 
	        React.DOM.h1(null, "React Combobox"),
	        React.DOM.p(null, React.DOM.a( {href:"https://github.com/rpflorence/react-combobox/blob/master/example/main.js"}, "Demo Source")),
	        React.DOM.p(null, "Selected State: ", this.state.selectedStateId),
	        Combobox(
	        ...
	        React.DOM.div(null, React.DOM.button(null, "something else to focus"))
	      )
	    );
	  }
	});
